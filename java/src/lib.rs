...
/*
 * Class:     com_github_kis3tar_RuAnnoy_NativeMethods
 * Method:    loadIndex
 * Signature: (Ljava/lang/String;IB)J
 */
// JNIEXPORT jlong JNICALL Java_com_github_kis3tar_RuAnnoy_NativeMethods_loadIndex
//   (JNIEnv *, jclass, jstring, jint, jbyte);
ffi_fn! {
    fn Java_com_github_kis3tar_RuAnnoy_NativeMethods_loadIndex(
        env: JNIEnv,
        class: JClass,
        path: JString,
        dimension: jint,
        ...
        let result = Java_com_github_kis3tar_RuAnnoy_NativeMethods_loadIndex_inner(
...
fn Java_com_github_kis3tar_RuAnnoy_NativeMethods_loadIndex_inner(
    env: JNIEnv,
    _class: JClass,
    path: JString,
    dimension: jint,
 ...
 * Signature: (J)V
 */
// JNIEXPORT void JNICALL Java_com_github_kis3tar_RuAnnoy_NativeMethods_freeIndex
//   (JNIEnv *, jclass, jlong);
ffi_fn! {
    fn Java_com_github_kis3tar_RuAnnoy_NativeMethods_freeIndex(
        env: JNIEnv,
        class: JClass,
        pointer: jlong,
    ) {
 ...
 * Signature: (J)J
 */
// JNIEXPORT jlong JNICALL Java_com_github_kis3tar_RuAnnoy_NativeMethods_getIndexSize
//   (JNIEnv *, jclass, jlong);
ffi_fn! {
    fn Java_com_github_kis3tar_RuAnnoy_NativeMethods_getIndexSize(
        env: JNIEnv,
        class: JClass,
        pointer: jlong,
    ) -> jlong {
 ...
 * Signature: (JJ)[F
 */
// JNIEXPORT jfloatArray JNICALL Java_com_github_kis3tar_RuAnnoy_NativeMethods_getItemVector
//   (JNIEnv *, jclass, jlong, jlong);
ffi_fn! {
    fn Java_com_github_kis3tar_RuAnnoy_NativeMethods_getItemVector(
        env: JNIEnv,
        _class: jclass,
        pointer: jlong,
        item_index: jlong,
 ...
 */
// JNIEXPORT jint JNICALL Java_com_github_kis3tar_RuAnnoy_NativeMethods_getNearestToItem
//   (JNIEnv *, jclass, jlong, jlong, jint, jint, jboolean, jlongArray, jfloatArray);
ffi_fn! {
    fn Java_com_github_kis3tar_RuAnnoy_NativeMethods_getNearestToItem(
        env: JNIEnv,
        _class: jclass,
        pointer: jlong,
        item_index: jlong,
 ...
 */
// JNIEXPORT jint JNICALL Java_com_github_kis3tar_RuAnnoy_NativeMethods_getNearest
//   (JNIEnv *, jclass, jlong, jfloatArray, jint, jint, jboolean, jlongArray, jfloatArray);
ffi_fn! {
    fn Java_com_github_kis3tar_RuAnnoy_NativeMethods_getNearest(
        env: JNIEnv,
        _class: jclass,
        pointer: jlong,
